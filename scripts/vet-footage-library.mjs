...
// 2026-07-16: o acervo de 69 clipes (9-12/pilar) era pequeno demais pro volume
...
const ALL_PILLARS = ["freedom", "dopamine", "anxiety", "network", "self", "mind"];
const PILLARS = PILLARS_FILTER.length ? ALL_PILLARS.filter((p) => PILLARS_FILTER.includes(p)) : ALL_PILLARS;

// Termos de busca por pilar — mais amplos que CAT_TERMS do runtime (aqui é
// CURADORIA, não busca ao vivo por post; queremos VARREDURA, não 1 termo certeiro).
const PILLAR_TERMS = {
  freedom: [
    "person arms open nature", "walking free open road", "person breathing calm outdoors",
    "putting phone away relief", "hiker mountain trail", "person cliff sunset silhouette",
    "open road solo travel", "person walking desert alone",
  ],
  dopamine: [
    "person scrolling phone in bed", "hand swiping smartphone screen", "phone notifications close up",
    "person addicted to phone night", "couple on phones in bed", "person scrolling social media dark room",
    "phone screen glow face night", "doomscrolling in bed",
  ],
  anxiety: [
    "anxious person looking at phone", "stressed person screen night", "overwhelmed person dark room",
    "rain window sad mood", "person head in hands stress", "burnout exhausted person desk",
    "person alone crying dark", "insomnia person bed night worried",
  ],
  network: [
    "people on phones ignoring each other", "lonely person in crowd", "couple distracted by phones",
    "person alone looking at screen", "couple back to back phones", "crowd silhouette anonymous city",
    "isolated person empty room", "friends together but on phones",
  ],
  self: [
    "person reflection window thinking", "alone silhouette window light", "thoughtful person low light",
    "person looking in mirror", "person journaling quiet room", "silhouette reading window city",
    "person deep in thought profile", "quiet introspective moment home",
  ],
  mind: [
    "calm person meditating", "person thinking by window", "slow breathing calm light",
    "quiet moment without phone", "meditation candle incense calm", "person breathing exercise outdoors",
    "peaceful morning routine calm", "person sitting still mindfulness",
  ],
};
