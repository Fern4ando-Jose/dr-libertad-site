...
```powershell
Invoke-WebRequest -Uri "https://www.drlibertad.com/api/migrate" -Headers @{ Authorization = "Bearer ***PURGED-SECRET***f06148196014ed1" } -UseBasicParsing | Select-Object -ExpandProperty Content
```
...
```powershell
Invoke-WebRequest -Uri "https://www.drlibertad.com/api/refresh-token" -Headers @{ Authorization = "Bearer ***PURGED-SECRET***f06148196014ed1" } -UseBasicParsing | Select-Object -ExpandProperty Content
```
...
Valor: `***PURGED-SECRET***f06148196014ed1`

Usar em todos os endpoints protegidos:
```powershell
-Headers @{ Authorization = "Bearer ***PURGED-SECRET***f06148196014ed1" }
```
...
```powershell
# Slot manhã
Invoke-WebRequest -Uri "https://www.drlibertad.com/api/publish?slot=manha" -Headers @{ Authorization = "Bearer ***PURGED-SECRET***f06148196014ed1" } -UseBasicParsing | Select-Object -ExpandProperty Content

# Slot tarde
Invoke-WebRequest -Uri "https://www.drlibertad.com/api/publish?slot=tarde" -Headers @{ Authorization = "Bearer ***PURGED-SECRET***f06148196014ed1" } -UseBasicParsing | Select-Object -ExpandProperty Content

# Slot noite
Invoke-WebRequest -Uri "https://www.drlibertad.com/api/publish?slot=noite" -Headers @{ Authorization = "Bearer ***PURGED-SECRET***f06148196014ed1" } -UseBasicParsing | Select-Object -ExpandProperty Content

# Com tema específico
Invoke-WebRequest -Uri "https://www.drlibertad.com/api/publish?slot=manha&topic=libertad+mental" -Headers @{ Authorization = "Bearer ***PURGED-SECRET***f06148196014ed1" } -UseBasicParsing | Select-Object -ExpandProperty Content
```
