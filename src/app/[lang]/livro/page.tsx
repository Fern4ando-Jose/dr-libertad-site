...
// TODO: trocar pelos links de checkout reais da Hotmart após a aprovação do produto.
// Produto PT criado na Hotmart: ID 7978640. A edição ES ainda será cadastrada.
const CHECKOUT: Record<string, string> = {
  pt: "https://hotmart.com",
  es: "https://hotmart.com",
};
...
export default function LivroPage() {
  ...
  const L = t.livro;
  const checkout = CHECKOUT[lang] ?? CHECKOUT.pt;
  const cover = `/images/livro-capa-${lang}.png`;
        ...
        <StudioContainer>
          <div className="relative grid gap-12 pt-28 pb-16 md:pt-32 md:pb-24 lg:grid-cols-12 lg:items-center">
            <div className="lg:col-span-7">
              ...
              <h1 className="mt-7 max-w-[16ch] font-serif text-[clamp(2.5rem,5.4vw,5rem)] leading-[0.95] tracking-[-0.045em] text-pretty">
