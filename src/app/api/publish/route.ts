...
// === Ensaio sobre a Morte (12 temas) ===
  ...
  { topic: "Amar no es apretar el puño: es abrir la mano", cat: "self", motif: "boundary", subject: "an open steady hand letting a small warm light rest and float freely, beside a clenched fist crushing the same light to darkness, symbolic, no people" }, // MEN1 · Amar não é apertar o punho: é abrir a mão
  { topic: "Apoyarte en alguien no es amar: es tener miedo de estar solo", cat: "self", motif: "isolation", subject: "a figure leaning its full weight on a shadow that dissolves, learning to stand on its own, calm light, no crowd" }, // MEN2 · Apoiar-se em alguém não é amar: é ter medo de ficar só
  { topic: "El adulto pierde de pie; el niño se queda en el ayer", cat: "freedom", motif: "descent", subject: "a lone figure standing tall and unbowed at the crest of a grey hill, gaze forward into breaking light, refusing to slump, no people around" }, // MEN3 · O adulto perde de pé; o menino fica preso no ontem
  { topic: "Construye sobre el hoy: el suelo del mañana no sostiene planes", cat: "self", motif: "branches", subject: "a solid glowing path being laid stone by stone on firm ground today, while the road ahead crumbles into an empty chasm, no people" }, // MEN4 · Construa sobre o hoje: o chão do amanhã não sustenta planos
  { topic: "Deja de esperar flores: conviértete en quien planta", cat: "self", motif: "branches", subject: "a figure planting a seed in bare earth with its own hands while an empty vase waits unfilled behind, self-sufficiency instead of waiting for a gift, no people giving" }, // MEN5 · Pare de esperar flores, vire quem planta
  { topic: "El ambiente te influye, no te absuelve: quien responde por ti eres tú", cat: "freedom", motif: "mirror", subject: "a figure facing a clear mirror, cutting the strings of blame that ran off to the surroundings, owning its own reflection, no captor" }, // MEN6 · O ambiente influencia, não absolve: quem responde por você é você
  { topic: "Tu único rival es el mejor que podrías ser", cat: "self", motif: "mirror", subject: "a figure racing not against a crowd of others but against a brighter version of its own silhouette running just ahead, no rivals" }, // MEN7 · Seu único rival é o melhor que você poderia ser
  { topic: "O gobiernas tus actos, o ellos te gobiernan a ti", cat: "self", motif: "boundary", subject: "a hand holding steady reins over a wild lower impulse, governing it instead of being dragged, calm and firm, no people" }, // MEN8 · Ou você governa seus atos, ou eles governam você
  { topic: "Ser flexible no es ser débil: es doblarse sin quebrarse", cat: "self", motif: "branches", subject: "a resilient reed bending in the storm without snapping beside a rigid iron bar cracking, flexibility as real strength, no people" }, // MEN9 · Ser flexível não é fraco: é dobrar sem se quebrar
  { topic: "Tienes derecho a tu rabia, no a la crueldad", cat: "anxiety", motif: "decay", subject: "a figure whose angry shadow looms large but is held behind a firm bright line before it turns cruel, restraint over lashing out, no target" }, // MEN10 · Direito à raiva, não à crueldade
  { topic: "A veces no alcanza con que te perdonen: tienes que perdonarte tú", cat: "self", motif: "embrace", subject: "a figure setting down a heavy stone it carried against itself, offering its own bare hand back to itself, self-forgiveness, no judge" }, // MEN11 · Não basta ser perdoado: você tem que se perdoar
  { topic: "La madurez no cuenta cumpleaños: cuenta lo que aprendiste", cat: "mind", motif: "clock", subject: "an hourglass where the falling sand builds a solid standing figure from lived experience rather than counting candles, no birthday imagery, no people" }, // MEN12 · Maturidade não conta aniversários
  { topic: "Aguantas mucho más de lo que crees", cat: "self", motif: "burst", subject: "a worn figure rising one step past the point it thought was its limit, a warm light breaking from within, dignity and worth, no applause needed" }, // MEN13 · Você aguenta muito mais do que pensa
];
...
- ENVÍOS (sends) — la palanca nº1 de alcance NUEVO (no-seguidores): en Instagram el LIKE solo reparte entre TUS seguidores; solo el ENVÍO en DM (share) abre la pieza a QUIEN AÚN NO te sigue. Por eso el "cta" es, ante todo, una LLAMADA A ENVIAR que NOMBRA al DESTINATARIO concreto ligado a ESTE tema ("manda esto a quien todavía cree que…", "etiqueta a esa persona que…") — así diseñan sus piezas los virales del nicho: se hacen para ser REENVIADAS a una persona identificable, no solo para gustar. Nombrar a QUIÉN multiplica el envío; el "compártelo con alguien" genérico NO. Súmalo a guardar (🔖).
