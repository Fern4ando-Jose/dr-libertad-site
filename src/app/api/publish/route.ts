...
// === Ensaio sobre a Morte (12 temas) ===
  ...
  { topic: "Amar no es sostener con el puño cerrado", cat: "self", motif: "boundary", subject: "an open steady hand letting a small warm light rest and float freely, beside a clenched fist crushing the same light to darkness, symbolic, no people" }, // MEN1 · Amar não é segurar de punho fechado
  { topic: "La compañía no es seguridad, y apoyarte en alguien no es amar", cat: "self", motif: "isolation", subject: "a figure leaning its full weight on a shadow that dissolves, learning to stand on its own, calm light, no crowd" }, // MEN2 · Companhia não é segurança
  { topic: "Perder de pie es de adulto; llorar el ayer, de niño", cat: "freedom", motif: "descent", subject: "a lone figure standing tall and unbowed at the crest of a grey hill, gaze forward into breaking light, refusing to slump, no people around" }, // MEN3 · Perder de pé é de adulto
  { topic: "Construí tus caminos en el hoy: el mañana se cae en el vacío", cat: "self", motif: "branches", subject: "a solid glowing path being laid stone by stone on firm ground today, while the road ahead crumbles into an empty chasm, no people" }, // MEN4 · Construa suas estradas no hoje
  { topic: "Dejá de esperar flores: convertite en quien planta", cat: "self", motif: "branches", subject: "a figure planting a seed in bare earth with its own hands while an empty vase waits unfilled behind, self-sufficiency instead of waiting for a gift, no people giving" }, // MEN5 · Pare de esperar flores, vire quem planta
  { topic: "El ambiente te influye, no te absuelve: de vos respondés vos", cat: "freedom", motif: "mirror", subject: "a figure facing a clear mirror, cutting the strings of blame that ran off to the surroundings, owning its own reflection, no captor" }, // MEN6 · O ambiente influencia, não absolve
  { topic: "No te compares con otros: competí con el mejor que podés ser", cat: "self", motif: "mirror", subject: "a figure racing not against a crowd of others but against a brighter version of its own silhouette running just ahead, no rivals" }, // MEN7 · Compita com o melhor que você pode ser
  { topic: "O gobernás tus actos, o ellos te gobiernan a vos", cat: "self", motif: "boundary", subject: "a hand holding steady reins over a wild lower impulse, governing it instead of being dragged, calm and firm, no people" }, // MEN8 · Ou você governa seus atos, ou eles governam você
  { topic: "Ser flexible no es ser débil: es tener dos lados y elegir", cat: "self", motif: "branches", subject: "a resilient reed bending in the storm without snapping beside a rigid iron bar cracking, flexibility as real strength, no people" }, // MEN9 · Flexível não é fraco
  { topic: "Tenés derecho a tu rabia, no a la crueldad", cat: "anxiety", motif: "decay", subject: "a figure whose angry shadow looms large but is held behind a firm bright line before it turns cruel, restraint over lashing out, no target" }, // MEN10 · Direito à raiva, não à crueldade
  { topic: "A veces no alcanza que te perdonen: tenés que perdonarte vos", cat: "self", motif: "embrace", subject: "a figure setting down a heavy stone it carried against itself, offering its own bare hand back to itself, self-forgiveness, no judge" }, // MEN11 · Não basta ser perdoado, tem que se perdoar
  ...
  { topic: "Aguantás más de lo que creés, y valés aunque nadie lo confirme", cat: "self", motif: "burst", subject: "a worn figure rising one step past the point it thought was its limit, a warm light breaking from within, dignity and worth, no applause needed" }, // MEN13 · Você aguenta mais do que pensa, e tem valor
];
