...
export const br = {
  ...
  dopamina: {
    ...
    subtitle: "O prazer, o vício e o caminho de volta ao equilíbrio — sem promessa milagrosa.",
    ...
    chips: ["Pré-venda com preço garantido", "Prévia grátis para ler", "Edição PT · ES", "E-pub na Amazon e Google Play"],
    metaDescription:
      "I Love Dopamina em pré-venda por R$ 29,90 com preço garantido. Baixe a prévia grátis e entenda como a sua atenção foi sequestrada — e o caminho de volta.",
    how: {
  ...
  tolos: {
    ...
    subtitle: "Um estudo da natureza humana — na forma de uma parábola.",
    lead: "Três homens amaram a mesma mulher; a vila achou que isso era a história inteira. Mas a história inteira é outra: o que cada um fez com o próprio jeito de ser quando a vida, pela primeira vez, pediu que fossem outra coisa.",
    price: "R$ 29,90",
    priceNote: "pré-lançamento · você garante o preço, sem pagar agora",
    ctaBuy: "Entrar na lista de espera",
    ctaSecondary: "Ver por dentro",
    ...
    metaDescription:
      "Tolos, Inteligentes e Sábios em pré-venda por R$ 29,90 com preço garantido. O romance parabólico sobre a natureza humana — sem herói, sem vilão.",
    how: {
      eyebrow: "Como funciona",
      title: "Pré-venda em 3 passos.",
      steps: [
    ...
    benefits: [
      ...
      { t: "A aposta, a feira, a enchente", d: "Os fatos grandes ninguém esqueceu. Em volta deles, a vida cobra o preço de cada jeito de ser." },
    ...
    insideEyebrow: "Por dentro",
    insideTitle: "Uma parábola que morde no fim.",
    insideLead: "O livro abre com o narrador que volta à vila, velho, carregando uma história que já é maior que ele. A vila dorme; os três homens descem a mesma rua — cada um do seu jeito — e a vida, enfim, pede contas.",
    ...
    finalTitle: "Guarde o seu exemplar.",
    finalLead: "Entre na lista de espera e garanta o preço de pré-lançamento. O livro está em finalização — você será avisado quando a compra abrir.",
  },
  livrosIndex: {
    eyebrow: "Biblioteca",
...
export const es: Dict = {
  ...
  dopamina: {
    ...
    title: "I Love",
    titleAccent: "Dopamina",
    subtitle: "El placer, el vicio y el camino de vuelta al equilibrio — sin promesa milagrosa.",
    ...
    chips: ["Preventa con precio asegurado", "Adelanto gratis para leer", "Edición PT · ES", "E-pub en Amazon y Google Play"],
    metaDescription:
      "I Love Dopamina en preventa por US$ 5,90 con precio asegurado. Descarga el adelanto gratis y entiende cómo secuestraron tu atención — y el camino de vuelta.",
    how: {
  ...
  tolos: {
    ...
    subtitle: "Un estudio de la naturaleza humana — en forma de parábola.",
    lead: "Tres hombres amaron a la misma mujer; el pueblo creyó que esa era la historia entera. Pero la historia entera es otra: qué hizo cada uno con su propia manera de ser cuando la vida, por primera vez, les pidió que fueran otra cosa.",
    price: "US$ 5,90",
    priceNote: "preventa · aseguras el precio, sin pagar ahora",
    ctaBuy: "Entrar en la lista de espera",
    ctaSecondary: "Ver por dentro",
    ...
    metaDescription:
      "Tolos, Inteligentes y Sabios en preventa por US$ 5,90 con precio asegurado. La novela parabólica sobre la naturaleza humana — sin héroe, sin villano.",
    how: {
      eyebrow: "Cómo funciona",
      title: "Preventa en 3 pasos.",
      steps: [
    ...
    benefits: [
      ...
      { t: "La apuesta, la feria, la creciente", d: "Los hechos grandes nadie los olvidó. A su alrededor, la vida cobra el precio de cada manera de ser." },
      { t: "El espejo sin absolución", d: "Escribir sin absolver a nadie — ni a sí mismo — es la apuesta de este libro. Prepárate a reconocerte." },
      { t: "La prosa como crítica", d: "Estilo elevado, corte seco: la elevación viene del ritmo y de la imagen, nunca del ornamento." },
    ],
    insideEyebrow: "Por dentro",
    insideTitle: "Una parábola que muerde al final.",
    insideLead: "El libro abre con el narrador que vuelve al pueblo, viejo, cargando una historia que ya es más grande que él. El pueblo duerme; los tres hombres bajan la misma calle — cada uno a su manera — y la vida, al fin, pide cuentas.",
    ...
    finalTitle: "Guarda tu ejemplar.",
    finalLead: "Entra en la lista de espera y asegura el precio de preventa. El libro está en finalización — te avisaremos cuando abra la compra.",
  },
  livrosIndex: {
    eyebrow: "Biblioteca",
