...
// RESTAURADO 2026-07-15: os 6 acentos DISTINTOS voltaram (a unificação p/ vinho fazia
// parte da direção grafite que o dono REPROVOU). A variação de cor NÃO é o problema —
// as capas que o dono AMA e postou têm cores próprias (a Nº 228 da mariposa é DOURADA/
// bronze; a ave tem faixa VERMELHA). O acento entra como UM ponto no prompt cinematográfico.
...
// Bloco de estilo de marca (fixo) + slot de subject por tema + enquadramento FIXO.
// DIREÇÃO RESTAURADA 2026-07-15 = CINEMATOGRÁFICO/ESCULTURAL editorial (a escolha de
// 2026-06-13 que GEROU as capas ricas que o dono APROVOU e POSTOU — ex.: Nº 228 da
// mariposa: imagem editorial dramática, semi-realista, fundo PRETO profundo, chiaroscuro,
// tons quentes bronze/dourado). A experiência "grafite/lápis sobre creme" (travada
// 2026-07-14) foi REPROVADA pelo dono ("destruiu a direção que já funcionava") →
// revertida ao texto literal do commit 8c048995. **PRESERVADO** desta rodada: o
